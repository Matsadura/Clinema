				...
				<div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8 lg:py-24">
					<div className="space-y-12">
						...
						<ul role="list"
							...
							{people.map((person) => (
								<li key={person.name}
									className="rounded-2xl about__card bg-secondary-light py-10 px-6 text-center xl:px-10 xl:text-left">
									<div className="space-y-6 xl:space-y-10">
										<img
											className="mx-auto h-40 w-40 bg-secondary select-none rounded-full xl:h-56 xl:w-56"
